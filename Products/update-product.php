...
if(isset($data->id) && isset($data->NombreProducto) && isset($data->Referencia) && isset($data->precio) && isset($data->Peso) && isset($data->Categoria) && isset($data->Stock) && isset($data->FechaCreacion)
    ...
    $updateProduct = mysqli_query($db_conn,"UPDATE productos SET NombreProducto=$NombreProducto,Referencia=$Referencia,precio=$precio,Peso=$Peso,Categoria=$Categoria,Stock=$Stock,FechaCreacion=$FechaCreacion WHERE WHERE id='$data->id'");
    if($updateProduct){
