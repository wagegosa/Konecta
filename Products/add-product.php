...
if(isset($data->NombreProducto) && isset($data->Referencia) && isset($data->precio) && isset($data->Peso) && isset($data->Categoria) && isset($data->Stock) && isset($data->FechaCreacion) 
    ...
    $insertProduct = mysqli_query($db_conn,"productos(ID, NombreProducto, Referencia, precio, Peso, Categoria, Stock, FechaCreacion) VALUES('$ID, $NombreProducto, $Referencia, $precio, $Peso, $Categoria, $Stock, $FechaCreacion')");
    if($insertProduct){
